    ...
    <main>
      <header className="topbar">
        <div className="container nav">
          ...
          <nav>
            ...
            <Link className="btn btn-secondary" href="/register">Đăng ký</Link>
          </nav>
        </div>
      </header>
      ...
      <section className="hero container">
        ...
        <div className="actions">
          <Link className="btn btn-primary" href="/login">Bắt đầu ôn thi</Link>
          <Link className="btn btn-light" href="/dashboard">Vào dashboard</Link>
        </div>
      </section>
